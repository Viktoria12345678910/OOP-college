...
bool MySqlDBManager::createTable() {
    ...
    if (!query.exec("CREATE TABLE IF NOT EXISTS " TABLE_STUDENTS " ("
                    TABLE_STUDENTS_ID               " VARCHAR(50)  PRIMARY KEY, "
...
bool MySqlDBManager::inserIntoTable(const Student& student) {
    ...
    query.prepare("INSERT INTO " TABLE_STUDENTS " ( "
                  ...
                  "VALUES (:FirstName, :LastName, :PaternalName, :Date, :Address, :PhoneNumber, :Faculty, :Year, :Group)");
    ...
    query.bindValue(":Address", student.getAddres());
...
Student MySqlDBManager::findStudentById(int id) {
